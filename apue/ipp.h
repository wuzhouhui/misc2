 ...
 *       Filename:  ipp.h
 *
 *    Description:  header file include IPP definition
 *
 *        Version:  1.0
 *        Created:  01/18/2015 03:01:45 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
#define STAT_CLI_TOOBIG		0x0408	/* request entity too big */
#define STAT_CLI_TOOLNG		0x0409	/* attrsribute value too large */
...
#define STAT_SRV_INTERM		0X500	/* unexpected internal error */
#define STAT_SRV_NOTSUP		0X501	/* operation not supported */
#define STAT_SRV_UNAVAIL	0X502	/* service unavailabel */
#define STAT_SRV_BADVER		0X503	/* version not supported */
#define STAT_SRV_DEVERR		0X504	/* device error */
#define STAT_SRV_TMPERR		0X505	/* temporary error */
#define STAT_SRV_REJECT		0X506	/* server not accepting jobs */
#define STAT_SRV_TOOBUSY	0X507	/* server too busy */
#define STAT_SRV_CANCEL		0X508	/* job has been canceled */
#define STAT_SRV_NOMULTI	0X509	/* multi-doc jbs unsupported */
...
#define TAG_OCTSTR		0x30	/* octetsring */
#define TAG_DATETIME		0x31	/* dataTime */
...
#define TAG_KEYWORD		0x44	/* key word */
