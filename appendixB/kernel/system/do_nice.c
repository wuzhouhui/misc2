 ...
 *
 * 该系统调用的参数包括:
 *	m1_i1:	PR_PROC_NR	需要改变优先级的进程号
 *	m1_i2:	PR_PRIORITY	新的优先级
 */
...
PUBLIC int do_nice(message *m_ptr)
{
   ...
   */
  /*
   * 现在 priority 的值在 PRIO_MIN 与 PRIO_MAX 之间. 我们必须把它调整
   * 到 MIN_USER_Q 与 MAX_USER_Q 之间.
   */
   ...
   */
  /*
   * 确保在改变进程优先级的时候, 进程没有在运行; max_priority 是优先级
   * 基值. 如果进程是可运行的, 就将它放到新的调度队列中.
   */
